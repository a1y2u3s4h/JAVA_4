...
/*
Q1:: Write a program which would contain 6 objects of a class student,Student[name ,age ,section,percentage].
 They all belong to section A.your program would be able to find the average percentage of the student
  in this section use constructors to create these 6 objects and input from scanner class
 */
public class Q1 {
